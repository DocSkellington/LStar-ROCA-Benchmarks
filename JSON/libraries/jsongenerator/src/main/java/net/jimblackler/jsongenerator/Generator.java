/* Copyright (C) 2021 – University of Mons, University Antwerpen for multiple changes over what can be generated by data type.
 * These changes are:
 * Strings are generated as "\S", integers as "\I", and doubles as "\D".
 * The tree depth is decremented by one each recursive call instead of being multiplied by 0.7
 * Restrictions over the length of an array were added.
 *
